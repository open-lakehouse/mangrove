...
impl PyCommitRequest {
    ...
    fn new(
        ...
        }
        {
            ...
            inner.commit_info = value.map(|w| w.into());
        }
        {
        ...
        {
            let value = metadata;
            inner.metadata = value.map(|w| w.into());
        }
        Self(inner)
    }
    #[getter]
    ...
    fn commit_info(&self) -> ::core::option::Option<PyCommitInfo> {
        self.0.commit_info.clone().map(PyCommitInfo::from)
    }
    #[getter]
    fn latest_backfilled_version(&self) -> ::core::option::Option<i64> {
        self.0.latest_backfilled_version
    }
    #[getter]
    fn metadata(&self) -> ::core::option::Option<PyMetadata> {
        self.0.metadata.clone().map(PyMetadata::from)
    }
    #[setter(table_id)]
    ...
    fn set_commit_info(&mut self, value: ::core::option::Option<PyCommitInfo>) {
        self.0.commit_info = value.map(|w| w.into());
    }
    ...
    fn set_metadata(&mut self, value: ::core::option::Option<PyMetadata>) {
        self.0.metadata = value.map(|w| w.into());
    }
    fn __repr__(&self) -> ::std::string::String {
        ::std::format!("{:?}", self.0)
    }
