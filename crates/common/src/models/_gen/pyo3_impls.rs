...
impl PyCreateCredentialRequest {
    ...
    fn read_only(&self) -> ::core::option::Option<bool> {
        self.0.read_only.clone()
    }
    #[getter]
    fn skip_validation(&self) -> ::core::option::Option<bool> {
        self.0.skip_validation.clone()
    }
    #[getter]
...
#[::pyo3::pyclass(name = "CommitInfo")]
#[derive(Clone, Debug)]
pub struct PyCommitInfo(pub super::delta_commits::v1::CommitInfo);
#[allow(clippy::too_many_arguments, clippy::useless_conversion)]
#[::pyo3::pymethods]
impl PyCommitInfo {
    #[new]
    #[pyo3(
        signature = (
            ...
            file_name = None,
            file_size = None,
            file_modification_timestamp = None
        )
    )]
    fn new(
        version: ::core::option::Option<i64>,
        timestamp: ::core::option::Option<i64>,
        file_name: ::core::option::Option<::std::string::String>,
        file_size: ::core::option::Option<i64>,
        file_modification_timestamp: ::core::option::Option<i64>,
    ) -> Self {
        let mut inner =
            <super::delta_commits::v1::CommitInfo as ::core::default::Default>::default();
        if let ::core::option::Option::Some(value) = version {
            inner.version = value;
        }
        if let ::core::option::Option::Some(value) = timestamp {
            inner.timestamp = value;
        }
        if let ::core::option::Option::Some(value) = file_name {
            inner.file_name = value;
        }
        if let ::core::option::Option::Some(value) = file_size {
            inner.file_size = value;
        }
        if let ::core::option::Option::Some(value) = file_modification_timestamp {
            inner.file_modification_timestamp = value;
        }
        Self(inner)
    }
    #[getter]
    ...
    #[getter]
    fn file_name(&self) -> ::std::string::String {
    ...
    #[getter]
    fn file_modification_timestamp(&self) -> i64 {
        self.0.file_modification_timestamp
    }
    #[setter(version)]
    ...
    #[setter(file_name)]
    fn set_file_name(&mut self, value: ::std::string::String) {
        self.0.file_name = value;
    }
    #[setter(file_size)]
    fn set_file_size(&mut self, value: i64) {
        self.0.file_size = value;
    }
    #[setter(file_modification_timestamp)]
    fn set_file_modification_timestamp(&mut self, value: i64) {
        self.0.file_modification_timestamp = value;
    }
    fn __repr__(&self) -> ::std::string::String {
        ::std::format!("{:?}", self.0)
    }
...
impl ::core::convert::From<super::delta_commits::v1::CommitInfo> for PyCommitInfo {
    fn from(value: super::delta_commits::v1::CommitInfo) -> Self {
        Self(value)
    }
}
impl ::core::convert::From<PyCommitInfo> for super::delta_commits::v1::CommitInfo {
    fn from(value: PyCommitInfo) -> Self {
        value.0
    }
}
#[::pyo3::pyclass(name = "CommitRequest")]
#[derive(Clone, Debug)]
pub struct PyCommitRequest(pub super::delta_commits::v1::CommitRequest);
#[allow(clippy::too_many_arguments, clippy::useless_conversion)]
#[::pyo3::pymethods]
impl PyCommitRequest {
    #[new]
    #[pyo3(
        signature = (
            table_id = None,
    ...
    fn new(
        ...
        table_uri: ::core::option::Option<::std::string::String>,
        commit_info: ::core::option::Option<PyCommitInfo>,
        latest_backfilled_version: ::core::option::Option<i64>,
        metadata: ::core::option::Option<PyMetadata>,
    ) -> Self {
        let mut inner =
            <super::delta_commits::v1::CommitRequest as ::core::default::Default>::default();
        if let ::core::option::Option::Some(value) = table_id {
            inner.table_id = value;
        }
        if let ::core::option::Option::Some(value) = table_uri {
            inner.table_uri = value;
        }
        {
            let value = commit_info;
            inner.commit_info = value
                .map(|w| ::buffa::MessageField::some(w.into()))
                .unwrap_or_default();
        }
        {
            let value = latest_backfilled_version;
            inner.latest_backfilled_version = value;
        }
        {
            let value = metadata;
            inner.metadata = value
    ...
    #[getter]
    fn table_uri(&self) -> ::std::string::String {
        self.0.table_uri.clone()
    }
    #[getter]
    fn commit_info(&self) -> ::core::option::Option<PyCommitInfo> {
        self.0
            .commit_info
            .clone()
            .into_option()
            .map(PyCommitInfo::from)
    }
    #[getter]
    fn latest_backfilled_version(&self) -> ::core::option::Option<i64> {
        self.0.latest_backfilled_version.clone()
    }
    #[getter]
    fn metadata(&self) -> ::core::option::Option<PyMetadata> {
        self.0.metadata.clone().into_option().map(PyMetadata::from)
    }
    #[setter(table_id)]
    ...
    #[setter(table_uri)]
    fn set_table_uri(&mut self, value: ::std::string::String) {
        self.0.table_uri = value;
    }
    #[setter(commit_info)]
    fn set_commit_info(&mut self, value: ::core::option::Option<PyCommitInfo>) {
        self.0.commit_info = value
            .map(|w| ::buffa::MessageField::some(w.into()))
            .unwrap_or_default();
    }
    #[setter(latest_backfilled_version)]
    fn set_latest_backfilled_version(&mut self, value: ::core::option::Option<i64>) {
        self.0.latest_backfilled_version = value;
    }
    #[setter(metadata)]
    fn set_metadata(&mut self, value: ::core::option::Option<PyMetadata>) {
        self.0.metadata = value
            .map(|w| ::buffa::MessageField::some(w.into()))
            .unwrap_or_default();
    }
...
impl ::core::convert::From<super::delta_commits::v1::CommitRequest> for PyCommitRequest {
    fn from(value: super::delta_commits::v1::CommitRequest) -> Self {
        Self(value)
    }
}
impl ::core::convert::From<PyCommitRequest> for super::delta_commits::v1::CommitRequest {
    fn from(value: PyCommitRequest) -> Self {
        value.0
    }
}
#[::pyo3::pyclass(name = "GetCommitsRequest")]
#[derive(Clone, Debug)]
pub struct PyGetCommitsRequest(pub super::delta_commits::v1::GetCommitsRequest);
#[allow(clippy::too_many_arguments, clippy::useless_conversion)]
#[::pyo3::pymethods]
impl PyGetCommitsRequest {
    #[new]
    #[pyo3(
        signature = (
            table_id = None,
    ...
    fn new(
        ...
        end_version: ::core::option::Option<i64>,
    ) -> Self {
        let mut inner =
            <super::delta_commits::v1::GetCommitsRequest as ::core::default::Default>::default();
        if let ::core::option::Option::Some(value) = table_id {
            inner.table_id = value;
        }
        if let ::core::option::Option::Some(value) = table_uri {
        ...
        if let ::core::option::Option::Some(value) = start_version {
            inner.start_version = value;
        }
        {
            let value = end_version;
            inner.end_version = value;
        }
        Self(inner)
    }
    #[getter]
    ...
    #[getter]
    fn end_version(&self) -> ::core::option::Option<i64> {
        self.0.end_version.clone()
    }
    #[setter(table_id)]
    fn set_table_id(&mut self, value: ::std::string::String) {
        self.0.table_id = value;
    ...
    fn set_start_version(&mut self, value: i64) {
        self.0.start_version = value;
    }
    #[setter(end_version)]
    fn set_end_version(&mut self, value: ::core::option::Option<i64>) {
        self.0.end_version = value;
    }
    fn __repr__(&self) -> ::std::string::String {
        ::std::format!("{:?}", self.0)
    }
...
impl ::core::convert::From<super::delta_commits::v1::GetCommitsRequest> for PyGetCommitsRequest {
    fn from(value: super::delta_commits::v1::GetCommitsRequest) -> Self {
        Self(value)
    }
}
impl ::core::convert::From<PyGetCommitsRequest> for super::delta_commits::v1::GetCommitsRequest {
    fn from(value: PyGetCommitsRequest) -> Self {
        value.0
    }
}
#[::pyo3::pyclass(name = "GetCommitsResponse")]
#[derive(Clone, Debug)]
pub struct PyGetCommitsResponse(pub super::delta_commits::v1::GetCommitsResponse);
#[allow(clippy::too_many_arguments, clippy::useless_conversion)]
#[::pyo3::pymethods]
impl PyGetCommitsResponse {
    #[new]
    #[pyo3(signature = (commits = None, latest_table_version = None))]
    fn new(
        commits: ::core::option::Option<::std::vec::Vec<PyCommitInfo>>,
        latest_table_version: ::core::option::Option<i64>,
    ) -> Self {
        let mut inner =
            <super::delta_commits::v1::GetCommitsResponse as ::core::default::Default>::default();
        if let ::core::option::Option::Some(value) = commits {
            inner.commits = value.into_iter().map(::core::convert::Into::into).collect();
        }
        if let ::core::option::Option::Some(value) = latest_table_version {
            inner.latest_table_version = value;
        }
        Self(inner)
    }
    #[getter]
    fn commits(&self) -> ::std::vec::Vec<PyCommitInfo> {
        self.0
            .commits
            .iter()
            .cloned()
    ...
    #[getter]
    fn latest_table_version(&self) -> i64 {
        self.0.latest_table_version
    }
    #[setter(commits)]
    fn set_commits(&mut self, value: ::std::vec::Vec<PyCommitInfo>) {
        self.0.commits = value.into_iter().map(::core::convert::Into::into).collect();
    }
    #[setter(latest_table_version)]
    fn set_latest_table_version(&mut self, value: i64) {
        self.0.latest_table_version = value;
    }
    fn __repr__(&self) -> ::std::string::String {
        ::std::format!("{:?}", self.0)
    }
...
impl ::core::convert::From<super::delta_commits::v1::GetCommitsResponse> for PyGetCommitsResponse {
    fn from(value: super::delta_commits::v1::GetCommitsResponse) -> Self {
        Self(value)
    }
}
impl ::core::convert::From<PyGetCommitsResponse> for super::delta_commits::v1::GetCommitsResponse {
    fn from(value: PyGetCommitsResponse) -> Self {
        value.0
    }
}
#[::pyo3::pyclass(name = "Metadata")]
#[derive(Clone, Debug)]
pub struct PyMetadata(pub super::delta_commits::v1::Metadata);
#[allow(clippy::too_many_arguments, clippy::useless_conversion)]
#[::pyo3::pymethods]
impl PyMetadata {
    #[new]
    #[pyo3(signature = (id = None, schema_string = None, configuration = None))]
    fn new(
        id: ::core::option::Option<::std::string::String>,
        schema_string: ::core::option::Option<::std::string::String>,
        configuration: ::core::option::Option<
            ::std::collections::HashMap<::std::string::String, ::std::string::String>,
        >,
    ) -> Self {
        let mut inner = <super::delta_commits::v1::Metadata as ::core::default::Default>::default();
        {
            let value = id;
            inner.id = value;
        }
        {
            let value = schema_string;
            inner.schema_string = value;
        }
        if let ::core::option::Option::Some(value) = configuration {
            inner.configuration = value;
        }
        Self(inner)
    }
    #[getter]
    ...
    #[getter]
    fn schema_string(&self) -> ::core::option::Option<::std::string::String> {
        self.0.schema_string.clone()
    }
    #[getter]
    fn configuration(
        &self,
    ...
    #[setter(schema_string)]
    fn set_schema_string(&mut self, value: ::core::option::Option<::std::string::String>) {
        self.0.schema_string = value;
    }
...
impl ::core::convert::From<super::delta_commits::v1::Metadata> for PyMetadata {
    fn from(value: super::delta_commits::v1::Metadata) -> Self {
        Self(value)
    }
}
impl ::core::convert::From<PyMetadata> for super::delta_commits::v1::Metadata {
...
impl PyFunctionParameterInfo {
    ...
    fn type_precision(&self) -> ::core::option::Option<i32> {
        self.0.type_precision.clone()
    }
    #[getter]
    fn type_scale(&self) -> ::core::option::Option<i32> {
        self.0.type_scale.clone()
    }
    #[getter]
...
impl PyGetShareRequest {
    ...
    fn include_shared_data(&self) -> ::core::option::Option<bool> {
        self.0.include_shared_data.clone()
    }
    #[setter(name)]
    fn set_name(&mut self, value: ::std::string::String) {
        self.0.name = value;
...
impl PyUpdatePermissionsRequest {
    ...
    fn omit_permissions_list(&self) -> ::core::option::Option<bool> {
        self.0.omit_permissions_list.clone()
    }
    #[setter(name)]
    fn set_name(&mut self, value: ::std::string::String) {
        self.0.name = value;
...
impl PyColumn {
    ...
    fn nullable(&self) -> ::core::option::Option<bool> {
        self.0.nullable.clone()
    }
    #[getter]
    fn partition_index(&self) -> ::core::option::Option<i32> {
        self.0.partition_index.clone()
    }
    #[getter]
...
impl PyGetTableRequest {
    ...
    fn include_delta_metadata(&self) -> ::core::option::Option<bool> {
        self.0.include_delta_metadata.clone()
    }
    #[getter]
    fn include_browse(&self) -> ::core::option::Option<bool> {
        self.0.include_browse.clone()
    ...
    fn include_manifest_capabilities(&self) -> ::core::option::Option<bool> {
        self.0.include_manifest_capabilities.clone()
    }
    #[setter(full_name)]
    fn set_full_name(&mut self, value: ::std::string::String) {
        self.0.full_name = value;
