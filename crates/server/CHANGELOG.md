...
## [0.0.7](https://github.com/open-lakehouse/mangrove/compare/olai-uc-server-v0.0.6...olai-uc-server-v0.0.7) - 2026-07-26
...
- server docker build (#180)

## [0.0.4](https://github.com/open-lakehouse/mangrove/compare/olai-uc-server-v0.0.3...olai-uc-server-v0.0.4) - 2026-07-26

### Added

- forward trusted identity header to upstream UC vends (#178)
- storage byte-proxy — wasm client, reverse-proxy auth, CORS docs (#172)
- same-origin storage byte-proxy — server-side (#163) (#166)
...
- [**breaking**] drop the undeveloped gRPC feature + fix crate README publishing (#101)

## [0.0.2](https://github.com/open-lakehouse/mangrove/compare/olai-uc-server-v0.0.1...olai-uc-server-v0.0.2) - 2026-07-16

### Fixed

- ui fingerprint (#97)

## [0.0.1](https://github.com/open-lakehouse/mangrove/releases/tag/olai-uc-server-v0.0.1) - 2026-07-12

### Added

- adopt olai-store SqlStore/PgStore, inline credential secrets (#46)
- expose the Delta log as queryable tables (#42)
- route authorization through one DeltaAction port hook (#33) (#38)
- extract the UC Delta v1 API into the olai-uc-delta-api crate (#37)
- rest UI wasm seed (#30)
- in-browser wasm query engine for table previews (#23) (#27)
- ABAC /policies endpoint (Databricks Policies API) (#22)
- query preview seam (#21)
...
- make getConfig capability-driven and negotiate protocol version (#31) (#41)
- make updateTable/createTable atomicity expressible in the port (#32, #34, #35) (#39)
