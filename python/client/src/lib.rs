...
use pyo3::prelude::*;
// The model types cross the FFI boundary as trestle-generated `#[pyclass]` wrapper
// structs/enums (`Py*`), each preserving the proto name on the Python side via
// `#[pyclass(name = "...")]`. They are re-exported from the models module root.
...
fn _client(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    // objects and enums (generated `Py*` wrappers; Python names preserved)
